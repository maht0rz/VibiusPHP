...
class DB
{
    ...
    public static function Connect()
    {
        self::$database = new PDO(
            configDB::$type . ":host=" . configDB::$host . ";dbname=" . configDB::$dbname . ";charset=utf8",
            configDB::$username,
            configDB::$password
        );
        $db = new DB();
    ...
    public function insert($what)
    {
        ...
        self::$query = self::$database->prepare(
            "INSERT INTO " . self::$table . " (" . $finalkeys . ") VALUES (" . $finalvalues . ")"
        );
        self::$query->execute();
